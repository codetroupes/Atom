package com.codetroupes.moleculexrouter.service.impl;
...
import com.codetroupes.moleculexrouter.constant.AcitivityStatus;
import com.codetroupes.moleculexrouter.constant.RouteType;
...
public class ActivityManagerImpl implements IProvider, ActivityManager, Application.ActivityLifecycleCallbacks{
    ...
    @Override
    public void updateActivity(Activity activity, @AcitivityStatus int status){
    ...
    @Override
    public <T extends Activity> List<T> getActivities(Class<T> clazz){
    ...
    @Override
    public void finishActivities(Class<? extends Activity> clazz){
