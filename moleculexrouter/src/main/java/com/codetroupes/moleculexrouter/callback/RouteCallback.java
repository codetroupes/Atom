package com.codetroupes.moleculexrouter.callback;
 ...
 * A callback for
 * <ul>
 * <li>{@link com.codetroupes.moleculexrouter.navigator.ActivityNavigator#startActivityForResult(RouteCallback)} </li>
 * <li>{@link com.codetroupes.moleculexrouter.navigator.Router#startActivityForResult(Postcard, int, RouteCallback)}</li>
 * </ul>
...
public abstract class RouteCallback<T>{
     ...
     * @see com.codetroupes.moleculexrouter.navigator.impl.RouterImpl#onActivityResult(Activity, int, int, Intent)
     */
