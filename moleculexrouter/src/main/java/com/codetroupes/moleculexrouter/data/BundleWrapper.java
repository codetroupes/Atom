...
public class BundleWrapper implements IBundleWrapper{
    ...
    @Override
    public IBundleWrapper put(@Type int type, String key, String value){
        switch(type){
        case Type.Boolean:
    ...
    @Override
    public IBundleWrapper put(String key, Object value){
        if(value == null){
            mBundle.remove(key);
    ...
    @Override
    public IBundleWrapper put(String key, ArrayList<String> value){
        mBundle.putStringArrayList(key, value);
        return this;
    }
    @Override
    public IBundleWrapper put(String key, String[] value){
        mBundle.putStringArray(key, value);
        return this;
    }
    @Override
    public <T extends Serializable> IBundleWrapper put(String key, List<T> value){
