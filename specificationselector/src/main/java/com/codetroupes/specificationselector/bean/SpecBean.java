package com.codetroupes.specificationselector.bean;
 ...
 * <p>
 * 注意，ValueBean {@link com.codetroupes.specificationselector.bean.SpecBean.AttrsBean.ValueBean} 是不可以被拓展的。因为在
 * AttrsBean {@link com.codetroupes.specificationselector.bean.SpecBean.AttrsBean} 中 value 是个 List ，
 * 经过查看sun的说明文档，在java中是”不能创建一个确切的泛型类型的数组”的。
 * 所以，把 AttrsBean {@link com.codetroupes.specificationselector.bean.SpecBean.AttrsBean} 设置为 final。
 * <p>
 * CombsBean  {@link com.codetroupes.specificationselector.bean.SpecBean.CombsBean}  同理
 * <p>
